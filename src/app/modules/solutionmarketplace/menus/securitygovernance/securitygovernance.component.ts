...
@Component({
  selector: 'app-securitygovernance',
  templateUrl: './securitygovernance.component.html',
  styleUrls: ['./securitygovernance.component.scss']
})
export class SecuritygovernanceComponent implements OnInit {
    private image1Url = '/assets/image/img/global-img/Security & Governance2.pdf'; 
    submitted = false;
    ...
    get f() {
          ...
          this.apiservice.post(URLS.contact, this.downloadForm.value)
            ...
            .subscribe((res: any) => {
              if (res && res.status == true) {
                this.downloadImages();
                (<any>$('#staticBackdrope')).modal('hide');
              }
            });
            this.clearForm();
          }
      ...
      downloadImages() {
        ...
        link1.download = 'Security & Governance2.pdf';
