...
@Component({
  selector: 'app-microsoftfabric',
  templateUrl: './microsoftfabric.component.html',
  styleUrls: ['./microsoftfabric.component.scss']
})
export class MicrosoftfabricComponent implements OnInit {
    private image1Url = '/assets/image/img/global-img/Microsoft Fabric Proof of Value (POV).pdf'; 
    submitted = false;
    ...
    get f() {
          ...
          this.apiservice.post(URLS.contact, this.downloadForm.value)
            ...
            .subscribe((res: any) => {
              if (res && res.status==true) {
                this.downloadImages();
                (<any>$('#staticBackdropse')).modal('hide');
              }
            });
            this.clearForm();
          }
      ...
      downloadImages() {
        ...
        link1.download = 'Microsoft Fabric POV.pdf';
