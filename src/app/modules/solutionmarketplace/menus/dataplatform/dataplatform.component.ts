...
@Component({
  ...
  templateUrl: './dataplatform.component.html',
  styleUrls: ['./dataplatform.component.scss']
})
export class DataplatformComponent implements OnInit {
    private image1Url = '/assets/image/img/global-img/Data and Platform Migration POV.pdf'; 
    submitted = false;
    ...
    get f() {
          ...
          this.apiservice.post(URLS.contact, this.downloadForm.value)
            ...
            .subscribe((res: any) => {
              if (res && res.status==true) {
                this.downloadImages();
                (<any>$('#staticBackdrops')).modal('hide');
              }
            });
            this.clearForm()
          }
      ...
      downloadImages() {
        ...
        link1.download = 'Data and Platform Migration POV.pdf';
