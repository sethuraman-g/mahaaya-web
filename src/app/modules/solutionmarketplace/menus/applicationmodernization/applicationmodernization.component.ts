...
@Component({
  selector: 'app-applicationmodernization',
  templateUrl: './applicationmodernization.component.html',
  styleUrls: ['./applicationmodernization.component.scss']
})
export class ApplicationmodernizationComponent implements OnInit {
    private image1Url = '/assets/image/img/global-img/Application Modernization.pdf'; 
    submitted = false;
    ...
    get f() {
          ...
          this.apiservice.post(URLS.contact, this.downloadForm.value)
            ...
            .subscribe((res: any) => {
              if (res && res.status==true) {
                this.downloadImages();
                (<any>$('#staticBackdropapp')).modal('hide');
              }
            });
            this.clearForm()
          }
      ...
      downloadImages() {
        ...
        link1.download = 'Application Modernization.pdf';
